...
#define MENU_INFO_ICON_PHYSICAL  (NUMBER_OF_MON_TYPES + 6)
#define MENU_INFO_ICON_SPECIAL   (NUMBER_OF_MON_TYPES + 7)
#define MENU_INFO_ICON_STATUS    (NUMBER_OF_MON_TYPES + 8)
